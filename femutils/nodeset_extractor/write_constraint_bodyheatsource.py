...
def write_meshdata_constraint(f, femobj, bodyheatsource_obj, ORwriter):
...
def write_constraint(f, femobj, bodyheatsource_obj, ORwriter):
    ...
    ref_sub_obj = ref[1][0]
    density = None
    for mat in ORwriter.member.mats_linear:
        mat_ref = [
