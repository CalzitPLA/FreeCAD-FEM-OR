...
def write_meshdata_constraint(f, femobj, rb_obj, ORwriter):
...
def write_constraint(f, femobj, rb_obj, ORwriter):

    rb_obj_idx = ORwriter.analysis.Group.index(rb_obj)
    node_count = ORwriter.mesh_object.FemMesh.NodeCount
