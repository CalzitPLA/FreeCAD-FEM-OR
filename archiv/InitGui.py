...
class FemUpgradedWorkbench(Workbench):
    "Fem upgraded workbench object"

    def __init__(self):
        self.__Workbench__ = "FemGui_upgraded::Workbench"
        self.__class__.Icon = FreeCAD.getResourceDir() + "Mod/Fem/Resources/icons/FemWorkbench.svg"
        self.__class__.MenuText = "FEM_upgraded"
        self.__class__.ToolTip = "FEM upgraded workbench"
    ...
    def Initialize(self):
        ...
        self.appendMenu("Solve", ["FEM_SolverRun", "FEM_FemKeywordEditor", "FEM_SolverControl"])

        # Define the toolbar directly
        self.appendToolbar("Solve", ["FEM_SolverRun", "FEM_FemKeywordEditor"])
    ...
    def GetClassName(self):
        ...
        return "FemGui_upgraded::Workbench"


FreeCADGui.addWorkbench(FemUpgradedWorkbench())
